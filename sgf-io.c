...
/************************************************************
 ...
 Description :
   ...
   - si ptr et pos ne sont pas un multiples de la taille des blocs
     - si le bloc souhaité n'est pas déja chargé,
        - charger le bloc souhaité dans le buffer
          (fonction sgf_read_block)
