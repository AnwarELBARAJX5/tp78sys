...
#define sgf_assert(test) { if(!(test)) panic_at(__FILE__, __LINE__, #test); }

/* vérifier une condition accompagnée d'un message*/
#define sgf_assert_msg(test,msg) { if(!(test)) panic_at(__FILE__, __LINE__, msg); }
